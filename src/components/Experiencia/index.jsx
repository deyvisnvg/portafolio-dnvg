import { silabuz, buildsoft, conf2 } from "../../assets/images"
    ...
    return (
        <section id="experience" className="relative text-white pt-16">
            <div>
                ...
                <h1 className="text-4xl sm:text-5xl font-bold uppercase pb-10">Más Sobre mi Experiencia</h1>
            </div>
            ...
            <div className="*:bg-gray-100 *:rounded-2xl text-black *:text-sm grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 *:w-full *:h-[480px] lg:*:h-[500px]">
                <article className="flex flex-col items-center p-2">
                    <figure className="w-11/12">
                        <img src={conf2} alt="conferencia4" className="rounded-2xl w-full h-52" />
                    </figure>
                    <div className="bg-white -m-24 px-5 py-3 w-10/12">
                        ...
                        <div className="text-center py-4">
                            <a className="p-3 border rounded-lg border-blue-700 text-blue-700 hover:bg-gray-100" href="https://www.netsolutions.pe/">Ver Plática</a>
                        </div>
                    </div>
                </article>
                ...
                <article className="flex flex-col items-center p-2">
                    ...
                    <div className="bg-white -m-24 px-5 py-3 w-10/12">
                        ...
                        <div className="text-center py-4">
                            <a className="p-3 border rounded-lg border-blue-700 text-blue-700 hover:bg-gray-100" href="http://www.buildsoft.com.pe/portalbs/#/">Ver Plática</a>
                        </div>
                    </div>
                </article>
                ...
                <article className="flex flex-col items-center p-2">
                    ...
                    <div className="bg-white -m-24 px-5 py-3 w-10/12">
                        ...
                        <div className="font-light py-2">
                            <p>Funciones del Cargo.</p>
                            <p className="pt-2">⚡ Desarrollo en java, .Net de formularios de reportes con millones de registros para la aseguradora Mapfre.</p>
