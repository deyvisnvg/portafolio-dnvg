        ...
        <header className="relative text-white h-screen flex flex-col justify-center">
            <div>
                ...
                <p className="pt-5 pb-14 text-xl tracking-wider leading-loose">
                    Hola bienvenido, soy<span className="border-b-2 border-green-500 pb-1"> fullstack developer </span>
                    de Perú
                </p>
            </div>

            <nav>
                <ul className="flex gap-x-10 gap-y-4
                *:transition *:ease-in-out *:duration-700 
                ...
                hover:*:text-white
                font-medium *:text-gray-400 flex-wrap"
                >
                    <li className="">
